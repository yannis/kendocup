...
cup = Kendocup::Cup.find_or_create_by start_on: 2.days.since.to_date, adult_fees_chf: 30, adult_fees_eur: 25, junior_fees_chf: 16, junior_fees_eur: 14
...
clubs_data.each do |c|
  p "club created" if Kendocup::Club.create! c
end
...
users_data = [
  {
    ...
    club_id: Kendocup::Club.find_by(name: "SDK Genève"),
    password: "12345678",
  ...
  },
  {
    ...
    club_id: Kendocup::Club.find_by(name: "Hokkaidō Police Dojo"),
    password: "12345678",
    password_confirmation: "12345678"
  }
]
users_data.each do |c|
  Kendocup::User.create! c
end
Kendocup::User.all.each(&:confirm!)
...
events_data.each do |e|
  Kendocup::Event.create! e.merge!(cup: cup)
end
...
products_data = [
  {
    ...
    fee_chf: 25,
    fee_eu: 20,
    event: Kendocup::Event.where(name_en: "Dinner").first
  },
  {
...
products_data.each do |e|
  Kendocup::Product.create! e.merge!(cup: cup)
end
...
individual_categories_data.each do |c|
  Kendocup::IndividualCategory.create! c
end
...
team_categories_data.each do |c|
  Kendocup::TeamCategory.create! c
end
