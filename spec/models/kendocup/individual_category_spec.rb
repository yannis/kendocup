...
module Kendocup
  RSpec.describe IndividualCategory, type: :model do
  ...
  describe "A individual_category “open”" do
    ...
    context "with 24 participations" do
      before {
        24.times do
          kenshi = create :kendocup_kenshi, cup: individual_category.cup
          participation = create :kendocup_participation, category: individual_category, kenshi: kenshi
        end
      }
