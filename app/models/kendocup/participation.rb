...
module Kendocup
  class Participation < ActiveRecord::Base
    ...
    def category_individual
      self.category.id if self.category.is_a?(Kendocup::IndividualCategory)
    end

    def category_team
      self.category.id if self.category.is_a?(Kendocup::TeamCategory)
    end
    ...
    def team_name=(team_name)
      if self.category.is_a? Kendocup::TeamCategory
